...
// document.write('<script src="' + bootPATH + '../lib/jquery/jquery.i18n.properties-min-1.0.9.js" type="text/javascript"></sc' + 'ript>');
...
//     lang = 'zh_CN';
// }
// document.write('<script src="' + bootPATH + '../lib/nui/locale/' + lang + '.js" type="text/javascript" ></sc' + 'ript>');
...
function goToLogin(params) {
    if (window.top != null) {
        if (params) {
            window.top.location.replace(bootPATH + "../syslogin.html" + params);
        } else {
            window.top.location.replace(bootPATH + "../syslogin.html");
        }
    }
}
...
function gridExportExcel(grid) {
    ...
    ajax_download(bootPATH + "../miniui/exportExcel", columns, "columns", grid.getData(), "data");
}
